...
public class MinimizingMakeChangeFitnessFunction extends FitnessFunction {
	...
	public static void main(String[] args) throws Exception {
		...
		// by the user.
		// ------------------------------------------------------------
		int targetAmount = Integer.parseInt("67");
		...
		for (int i = 0; i < MAX_ALLOWED_EVOLUTIONS; i++) {
			...
			if (bestSolutionSoFar == null || bestSolutionSoFar.getFitnessValue() < fittestChromosome.getFitnessValue())
				bestSolutionSoFar = fittestChromosome;
		}
